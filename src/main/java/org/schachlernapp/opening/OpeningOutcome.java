...
public enum OpeningOutcome {
    ...
    CORRECT_CONTINUE,
    /**
     * User-Zug wich vom Buchzug ab - der Zug wurde zurückgenommen, der User kann ihn wiederholen.
     * Der erwartete Buchzug steht in {@code OpeningFeedback.expectedUci()}.
     */
    DEVIATION,
